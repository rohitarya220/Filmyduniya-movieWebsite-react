  ...
  return (
    <div className=' flex flex-wrap justify-between p-3 mt-2'>
      ...
      {loading ? <div className=' w-full flex justify-center items-center h-96'><ThreeDots height={40} color='white' /></div> :   
       ...
       return ( 
         <Link to={`/detail/${e.id}`}> 
           <div key={i} className='card font-medium shadow-lg rounded-md p-2 m-2 hover:-translate-y-3 cursor-pointer mt-3 transition-all duration-500 '>
            <img className=' h-40 w-36 md:h-60 md:w-56  ' src={e.image} alt="" />
